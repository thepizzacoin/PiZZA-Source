...
uint256 hashGenesisBlock("0x00000602a17bffd84ff336c58525a2c5a36acbc98afad8aa61408f112ab33ce6");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // PIZZA: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "PIZZA Signed Message:\n";
...
{
    // PIZZA: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetTimespan = 24 * 60 * 60; // PIZZA: 1 day
static const int64 nTargetSpacing = 60; // PIZZA: 1 minute
static const int64 nTargetTimespanNEW = 60 ; // PIZZA / digishield: every 1 minute
...
unsigned int static GetNextWorkRequired_V1(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // PIZZA: This fixes an issue where a 51% attack can change difficulty at will.
...
{
        static const int64 BlocksTargetSpacing = 60; // PIZZA: 1 minute
        static const unsigned int TimeDaySeconds = 24 * 60 * 60; // PIZZA: 1 day
...
{
    // PIZZA: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    // vMerkleTree: b0019d92bc054f7418960c91e252e7d24c77719c7a30128c5f6a827c73095d2a 
		...
		const char* pszTimestamp = "PIZZA launch 2016!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
 ...
 if (false && block.GetHash() != hashGenesisBlock)
        ...
        printf("%s\n", block.hashMerkleRoot.ToString().c_str());
        assert(block.hashMerkleRoot == uint256("0x44830b3c362786cbf64038499f8eba7d72dc7f219fd6b8a4206feeae4cfa1522"));
...
unsigned char pchMessageStart[4] = { 0xfe, 0xc3, 0xb9, 0xde }; // PIZZA: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("PIZZAMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("PIZZAMiner : ProcessBlock, block not accepted");
    }
